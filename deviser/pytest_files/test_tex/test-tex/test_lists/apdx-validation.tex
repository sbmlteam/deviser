...
Level~3 Specification for Foo, Version~1 \sec{xml-namespace}.)}
...
Specification for Foo, Version~1 \sec{xml-namespace}.)}
...
SBML Level~3 Specification for Foo, Version~1,
...
object may only contain \Apple objects. (Reference: SBML Level~3
Specification for Foo, Version~1, \sec{extended-model-class}.)}
...
\ListOfApples object. (Reference: SBML Level~3 Specification for Foo,
...
(Reference: SBML Level~3 Specification for Foo, Version~1,
\sec{extended-compartment-class}.)}
...
object may only contain \Pear objects. (Reference: SBML Level~3
Specification for Foo, Version~1, \sec{extended-compartment-class}.)}

\validRule{foo-20303}{A \ListOfPears object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ListOfPears object. (Reference: SBML Level~3 Specification for Foo,
Version~1, \sec{extended-compartment-class}.)}
...
Specification for Foo, Version~1, \sec{extended-species-class}.)}

\validRule{foo-20404}{A \ListOfBananas object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ListOfBananas object. (Reference: SBML Level~3 Specification for Foo,
...
Level~3 Specification for Foo, Version~1, \sec{bowl-class}.)}
...
attributes from the SBML Level~3 Core namespaces are permitted on a
\ListOfPears object. (Reference: SBML Level~3 Specification for Foo,
Version~1, \sec{listofpears-class}.)}
...
SBML Level~3 Specification for Foo, Version~1, \sec{plate-class}.)}
...
must not be empty. (Reference: SBML Level~3 Specification for Foo,
Version~1, \sec{plate-class}.)}

\validRule{foo-20807}{Apart from the general notes and annotations
subobjects permitted on all SBML objects, a \ListOfBananas container
object may only contain \Banana objects. (Reference: SBML Level~3
Specification for Foo, Version~1, \sec{listofbananas-class}.)}

\validRule{foo-20808}{A \ListOfApples object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ListOfApples object. (Reference: SBML Level~3 Specification for Foo,
Version~1, \sec{listofapples-class}.)}

\validRule{foo-20809}{A \ListOfBananas object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ListOfBananas object. (Reference: SBML Level~3 Specification for Foo,
Version~1, \sec{listofbananas-class}.)}
