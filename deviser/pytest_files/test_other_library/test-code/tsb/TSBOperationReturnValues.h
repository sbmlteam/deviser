/**
 * @file TSBOperationReturnValues.h
 * @brief Definition of the TSBOperationReturnValues class.
 * @author DEVISER
 *
 * <!--------------------------------------------------------------------------
 ...
 * ------------------------------------------------------------------------ -->
 *
 * @class TSBOperationReturnValues
 * @sbmlbrief{} TODO:Definition of the TSBOperationReturnValues class.
 */



#ifndef LIBTSB_OPERATION_RETURN_VALUES_H
#define LIBTSB_OPERATION_RETURN_VALUES_H
 ...
 * LibTSB diagnostic return codes.
 *
 * Many methods in libTSB return a status code to indicate whether the
 * operation requested by the caller succeeded or failed.  This enumeration
 * lists all the possible return codes from any libTSB methods.
 */
typedef enum
{
...
} TSBOperationReturnValues_t;

/**
 * This method takes an TSB operation return value and returns a string representing
 * the code.
 *
...
#endif  /* LIBTSB_OPERATION_RETURN_VALUES_H */
