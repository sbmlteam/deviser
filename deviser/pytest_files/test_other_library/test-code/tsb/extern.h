 ...
 * LIBTSB_EXTERN functions as being imported from a DLL, wheras this DLL
 * sees symbols defined with this macro as being exported.
 *
 * (From Andrew Finney's sbwdefs.h, with "SBW" replaced by "LIBTSB" :)
 */
#if defined(LIBTSB_EXPORTS)
#  define LIBTSB_EXTERN __declspec(dllexport)
#else
#  define LIBTSB_EXTERN __declspec(dllimport)
#endif

#else
#  define LIBTSB_EXTERN
#endif  /* LIBTSB_STATIC */
...
/**
 * LIBTSB_EXTERN is used under Windows to simplify exporting functions
 ...
 * LIBTSB_EXTERN that is appropriate for exporting functions to client
