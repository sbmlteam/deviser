...
#ifndef LIBTSB_COMMON_H
#define LIBTSB_COMMON_H 1
...
/**
 * Default format used by libTSB when writing out floating-point numbers
 * into the XML produced by libTSB.  This is used by
 * StringBuffer_appendReal.
 */
#define LIBTSB_FLOAT_FORMAT "%.15g"

#define LIBTSB_DOUBLE_PRECISION 15

static const int TSB_INT_MAX = 2147483647;
static const int TSB_INT_MIN = -2147483647 - 1;
...
#define LIBTSB_UNKNOWN_LINE	TSB_INT_MAX
#define LIBTSB_UNKNOWN_COLUMN	TSB_INT_MAX
