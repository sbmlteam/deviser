...
(Reference: SBML Level~3 Package specification for Qualitative Models,
Version~1 \sec{xml-namespace}.)}

\validRule{qual-10102}{Wherever they appear in an SBML document,
elements and attributes from the \QualitativeModelsPackage must be
declared either implicitly or explicitly to be in the XML namespace
\uri{http://www.sbml.org/sbml/level3/version1/qual/version1}.
(Reference: SBML Level~3 Package specification for Qualitative Models,
Version~1 \sec{xml-namespace}.)}
...
Level~3 Package specification for Qualitative Models, Version~1
\sec{primitive-types}.)}
...
a \ListOfTransitions object. (Reference: SBML Level~3 Package
specification for Qualitative Models, Version~1, \sec{model-class}.)}
...
object. (Reference: SBML Level~3 Package specification for Qualitative
...
\QualitativeSpecies must have a value of data type \token{integer}.
(Reference: SBML Level~3 Package specification for Qualitative Models,
Version~1, \sec{qualitativespecies-class}.)}
...
permitted on a \Transition object. (Reference: SBML Level~3 Package
...
SBML Level~3 Package specification for Qualitative Models, Version~1,
\sec{transition-class}.)}

\validRule{qual-20406}{The \ListOfInputs and \ListOfOutputs subobjects
on a \Transition object is optional, but if present, these container
objects must not be empty. (Reference: SBML Level~3 Package
specification for Qualitative Models, Version~1,
\sec{transition-class}.)}
...
object may only contain \Input objects. (Reference: SBML Level~3 Package
specification for Qualitative Models, Version~1,
\sec{transition-class}.)}
...
\validRule{qual-20409}{Apart from the general notes and annotations
...
\validRule{qual-20410}{A \ListOfInputs object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level 3 Core namespaces are permitted on a
\ListOfInputs object. (Reference: SBML Level~3 Package specification for
Qualitative Models, Version~1, \sec{transition-class}.)}

\validRule{qual-20411}{A \ListOfOutputs object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level 3 Core namespaces are permitted on
a \ListOfOutputs object. (Reference: SBML Level~3 Package specification
for Qualitative Models, Version~1, \sec{transition-class}.)}

\validRule{qual-20412}{A \ListOfFunctionTerms object may have the
optional SBML Level~3 Core attributes \token{metaid} and
\token{sboTerm}. No other attributes from the SBML Level 3 Core
...
permitted on an \Input object. (Reference: SBML Level~3 Package
...
following: 'positive', 'negative', 'dual' or 'unknown'. (Reference: SBML
Level~3 Package specification for Qualitative Models, Version~1,
\sec{input-class}.)}
...
in SBML; that is the value must be one of the following: 'none' or
'consumption'. (Reference: SBML Level~3 Package specification for
Qualitative Models, Version~1, \sec{input-class}.)}

\validRule{qual-20508}{The attribute \token{qual:\-thresholdLevel} on an
\Input must have a value of data type \token{integer}. (Reference: SBML
Level~3 Package specification for Qualitative Models, Version~1,
\sec{input-class}.)}
...
are permitted on an \Output object. (Reference: SBML Level~3 Package
...
identifier of an existing \QualitativeSpecies object defined in the
enclosing \Model object. (Reference: SBML Level~3 Package specification
for Qualitative Models, Version~1, \sec{output-class}.)}
...
in SBML; that is the value must be one of the following: 'production' or
'assignmentLevel'. (Reference: SBML Level~3 Package specification for
...
\DefaultTerm must have a value of data type \token{integer}. (Reference:
SBML Level~3 Package specification for Qualitative Models, Version~1,
...
\FunctionTerm must have a value of data type \token{integer}.
(Reference: SBML Level~3 Package specification for Qualitative Models,
