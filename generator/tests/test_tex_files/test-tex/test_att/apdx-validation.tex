...
specification for testAttributes, Version~1, \sec{species-class}.)}
...
and \token{test:\-metaidrefOne}. No other attributes from the SBML Level
3 testAttributes namespaces are permitted on a \MyRequiredClass object.
(Reference: SBML Level~3 Package specification for testAttributes,
