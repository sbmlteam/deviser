...
for testAttributes, Version~1, \sec{extended-species-class}.)}
...
(Reference: SBML Level~3 Specification for testAttributes, Version~1,
...
SBML Level~3 Specification for testAttributes, Version~1,
\sec{mytestclass-class}.)}

\validRule{test-20305}{The attribute \token{test:\-num} on a
\MyTestClass must have a value of data type \token{integer}, and must be
non negative. (Reference: SBML Level~3 Specification for testAttributes,
...
in SBML. (Reference: SBML Level~3 Specification for testAttributes,
Version~1, \sec{mytestclass-class}.)}
...
Specification for testAttributes, Version~1, \sec{mytestclass-class}.)}
...
units in SBML. (Reference: SBML Level~3 Specification for
testAttributes, Version~1, \sec{mytestclass-class}.)}

\validRule{test-20315}{The value of the attribute \token{test:\-idRef}
of a \MyTestClass object must be the 'metaid' of an existing \SBase
object defined in the enclosing \Model object. (Reference: SBML Level~3
Specification for testAttributes, Version~1, \sec{mytestclass-class}.)}

\validRule{test-20316}{The value of the attribute
\token{test:\-idrefOne} of a \MyTestClass object must be the 'metaid' of
an existing \SBase object defined in the enclosing \Model object.
(Reference: SBML Level~3 Specification for testAttributes, Version~1,
\sec{mytestclass-class}.)}

\validRule{test-20317}{The value of the attribute
\token{test:\-idrefTwo} of a \MyTestClass object must be the 'metaid' of
an existing \SBase object defined in the enclosing \Model object.
(Reference: SBML Level~3 Specification for testAttributes, Version~1,
\sec{mytestclass-class}.)}
...
\token{test:\-metaidTwo}, \token{test:\-metaidOne},
\token{test:\-numFour}, \token{test:\-metaidrefOne} and
\token{test:\-notmetaid}, and may have the optional attributes
\token{test:\-vectorDouble}, \token{test:\-vectorDoubleOne},
\token{test:\-vectorInt}, \token{test:\-vectorIntOne},
\token{test:\-arrayD} and \token{test:\-arrayInt}. No other attributes
from the SBML Level~3 testAttributes namespaces are permitted on a
\MyRequiredClass object. (Reference: SBML Level~3 Specification for
...
of the base units in SBML. (Reference: SBML Level~3 Specification for
testAttributes, Version~1, \sec{myrequiredclass-class}.)}
...
\validRule{test-20618}{The attribute \token{test:\-metaidTwo} on a
...
\validRule{test-20621}{The value of the attribute
\token{test:\-metaidrefOne} of a \MyRequiredClass object must be the
...
of values of type \token{int}. (Reference: SBML Level~3 Specification
for testAttributes, Version~1, \sec{myrequiredclass-class}.)}
...
\token{double}. (Reference: SBML Level~3 Specification for
testAttributes, Version~1, \sec{myrequiredclass-class}.)}

\validRule{test-20628}{The value of the attribute
\token{test:\-arrayInt} of a \MyRequiredClass object must be an array of
values of type \token{integer}. (Reference: SBML Level~3 Specification
for testAttributes, Version~1, \sec{myrequiredclass-class}.)}
...
attribute \token{test:\-number}. No other attributes from the SBML
Level~3 testAttributes namespaces are permitted on an \ArrayChild
object. (Reference: SBML Level~3 Specification for testAttributes,
Version~1, \sec{arraychild-class}.)}

\validRule{test-20704}{An \ArrayChild object may contain one and only
one instance of the Unit element. No other elements from the SBML
Level~3 testAttributes namespaces are permitted on an \ArrayChild
object. (Reference: SBML Level~3 Specification for testAttributes,
Version~1, \sec{arraychild-class}.)}
...
object. (Reference: SBML Level~3 Specification for testAttributes,
Version~1, \sec{container-class}.)}

\validRule{test-20804}{Apart from the general notes and annotations
...
\validRule{test-20805}{A \ListOfMyLoTests object may have the optional
SBML Level~3 Core attributes \token{metaid} and \token{sboTerm}. No
other attributes from the SBML Level~3 Core namespaces are permitted on
a \ListOfMyLoTests object. (Reference: SBML Level~3 Specification for
testAttributes, Version~1, \sec{listofmylotests-class}.)}
...
\subsubsection*{Rules for \class{Unit1} object}

\validRule{test-20901}{An \UnitOne object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on an
\UnitOne. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{test-20902}{An \UnitOne object may have the optional SBML
Level~3 Core subobjects for notes and annotations. No other elements
from the SBML Level~3 Core namespaces are permitted on an \UnitOne.
(Reference: SBML Level~3 Version~1 Core, Section~3.2.)}


\subsubsection*{Rules for \class{Thing1} object}

\validRule{test-21001}{A \ThingOne object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ThingOne. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{test-21002}{A \ThingOne object may have the optional SBML
Level~3 Core subobjects for notes and annotations. No other elements
from the SBML Level~3 Core namespaces are permitted on a \ThingOne.
(Reference: SBML Level~3 Version~1 Core, Section~3.2.)}


\subsubsection*{Rules for \class{Thing2} object}

\validRule{test-21101}{A \ThingTwo object may have the optional SBML
Level~3 Core attributes \token{metaid} and \token{sboTerm}. No other
attributes from the SBML Level~3 Core namespaces are permitted on a
\ThingTwo. (Reference: SBML Level~3 Version~1 Core, Section~3.2.)}

\validRule{test-21102}{A \ThingTwo object may have the optional SBML
Level~3 Core subobjects for notes and annotations. No other elements
from the SBML Level~3 Core namespaces are permitted on a \ThingTwo.
(Reference: SBML Level~3 Version~1 Core, Section~3.2.)}
