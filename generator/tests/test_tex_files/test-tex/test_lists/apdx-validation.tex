...
Foo, Version~1, \sec{extended-model-class}.)}
...
Foo, Version~1, \sec{extended-compartment-class}.)}
...
Package specification for Foo, Version~1,
\sec{extended-species-class}.)}
...
for Foo, Version~1, \sec{extended-species-class}.)}
