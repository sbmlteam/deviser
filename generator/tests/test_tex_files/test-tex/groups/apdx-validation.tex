...
for Groups, Version~1, \sec{extended-model-class}.)}
...
for Groups, Version~1, \sec{member-class}.)}

\validRule{groups-20406}{The attribute \token{groups:\-metaIdRef} on a
\Member must have a value of XML data type \token{ID}. (Reference: SBML
Level~3 Package specification for Groups, Version~1,
\sec{member-class}.)}
