...
/*
 * Gets the value of the "attributeName" attribute of this Child.
 */
int
Child::getAttribute(const std::string& attributeName, bool& value) const
{
 ...
 */
int
Child::getAttribute(const std::string& attributeName, int& value) const
{
  int return_value = SBase::getAttribute(attributeName, value);
 ...
 */
int
Child::getAttribute(const std::string& attributeName, double& value) const
{
  int return_value = SBase::getAttribute(attributeName, value);
 ...
 */
int
Child::getAttribute(const std::string& attributeName,
 ...
 */
int
Child::getAttribute(const std::string& attributeName, const char* value) const
{
  int return_value = SBase::getAttribute(attributeName, value);
...
/*
 * Predicate returning @c true if this Child's attribute "attributeName" is
 * set.
 */
bool
Child::isSetAttribute(const std::string& attributeName) const
{
...
/*
 * Sets the value of the "attributeName" attribute of this Child.
 */
int
Child::setAttribute(const std::string& attributeName, bool value)
{
 ...
 */
int
Child::setAttribute(const std::string& attributeName, int value)
{
  int return_value = SBase::setAttribute(attributeName, value);
 ...
 */
int
Child::setAttribute(const std::string& attributeName, double value)
{
  int return_value = SBase::setAttribute(attributeName, value);
 ...
 */
int
Child::setAttribute(const std::string& attributeName, unsigned int value)
{
  int return_value = SBase::setAttribute(attributeName, value);
 ...
 */
int
Child::setAttribute(const std::string& attributeName,
 ...
 */
int
Child::setAttribute(const std::string& attributeName, const char* value)
{
  int return_value = SBase::setAttribute(attributeName, value);
...
/*
 * Unsets the value of the "attributeName" attribute of this Child.
 */
int
Child::unsetAttribute(const std::string& attributeName)
{
