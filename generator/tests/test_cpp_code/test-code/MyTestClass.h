 ...
 *
 * @class MyTestClass
 * @sbmlbrief{test} TODO:Definition of the MyTestClass class.
 */
...
public:
  ...
  /**
   * Predicate returning @c true if this MyTestClass's attribute
   * "attributeName" is set.
   *
   * @param attributeName, the name of the attribute to query.
   *
   * @return @c true if this MyTestClass's attribute "attributeName" has been
 ...
 * to calling MyTestClass_unsetId().
 *
 * @memberof MyTestClass_t
 */
LIBSBML_EXTERN
 ...
 *
 * Calling this function with @p correctId = @c NULL or an empty string is
 * equivalent to calling MyTestClass_unsetCorrectId().
 *
 * @memberof MyTestClass_t
 */
LIBSBML_EXTERN
