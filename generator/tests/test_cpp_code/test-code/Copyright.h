...
public:
  ...
  /**
   * Predicate returning @c true if this Copyright's attribute "attributeName"
   * is set.
   *
   * @param attributeName, the name of the attribute to query.
   *
   * @return @c true if this Copyright's attribute "attributeName" has been
 ...
 * @param c the Copyright_t structure.
 *
 * @return @c 1 (true) if this Copyright_t's "id" attribute has been set,
