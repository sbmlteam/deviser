 ...
 * @brief Definition of the ExponentialDistribution class.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
 ...
 * @sbmlbrief{distrib} TODO:Definition of the ExponentialDistribution class.
 */


#ifndef ExponentialDistribution_H__
#define ExponentialDistribution_H__
...
class LIBSBML_EXTERN ExponentialDistribution : public
...
public:
   ...
   *
   * @param orig the ExponentialDistribution instance to copy.
   */
  ExponentialDistribution(const ExponentialDistribution& orig);


  /**
   * Assignment operator for ExponentialDistribution.
   *
   * @param rhs the ExponentialDistribution object whose values are to be used
   ...
   *
   * @return a (deep) copy of this ExponentialDistribution object.
   */
  virtual ExponentialDistribution* clone() const;
   ...
   *
   * @return the value of the "rate" element of this ExponentialDistribution as
   * a UncertValue*.
   */
  const UncertValue* getRate() const;
  ...
  /**
   * Predicate returning @c true if this ExponentialDistribution's "rate"
   * element is set.
   *
   * @return @c true if this ExponentialDistribution's "rate" element has been
   ...
   *
   * @param rate UncertValue* value of the "rate" element to be set.
   *
   ...
   */
  int setRate(const UncertValue* rate);
   ...
   *
   * @sbmlconstant{SBML_DISTRIB_EXPONENTIALDISTRIBUTION, SBMLDistribTypeCode_t}
   *
   ...
   * ExponentialDistribution have been set, otherwise @c false is returned.
   *
   *
   * @note The required attributes for the ExponentialDistribution object are:
   */
   ...
   *
   *
   * @note The required elements for the ExponentialDistribution object are:
   * @li "rate"
   */
   ...
   *
   * @return @c true if this ExponentialDistribution's attribute
 ...
 *
 * @param ed the ExponentialDistribution_t structure whose rate is sought.
 *
 * @return the value of the "rate" element of this ExponentialDistribution_t as
 * a UncertValue*.
 *
 * @memberof ExponentialDistribution_t
 */
 ...
 * @param ed the ExponentialDistribution_t structure.
 *
 * @param rate UncertValue_t* value of the "rate" element to be set.
 *
 * @copydetails doc_returns_success_code
 * @li @sbmlconstant{LIBSBML_OPERATION_SUCCESS, OperationReturnValues_t}
 ...
 * created.
 *
 * @param ed the ExponentialDistribution_t structure to which the UncertValue_t
 * should be added.
 *
 ...
 *
 *
 * @note The required attributes for the ExponentialDistribution_t object are:
 *
 * @memberof ExponentialDistribution_t
 */
LIBSBML_EXTERN
...
#endif /* !ExponentialDistribution_H__ */
