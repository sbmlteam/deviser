 ...
 *
 * @class Polygon
 * @sbmlbrief{render} TODO:Definition of the Polygon class.
 */
...
public:
   ...
   * Polygon object have been set.
   *
   * @return @c true to indicate that all the required attributes of this
   * Polygon have been set, otherwise @c false is returned.
   */
   ...
   *
   * @return @c true to indicate that all the required elements of this Polygon
   * have been set, otherwise @c false is returned.
   *
   *
   * @note The required elements for the Polygon object are:
   */
   ...
   *
   * @return @c true if this Polygon's attribute "attributeName" has been set,
