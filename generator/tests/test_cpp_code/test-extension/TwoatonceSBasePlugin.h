...
public:
   ...
   *
   * @return the value of the "id" attribute of this TwoatonceSBasePlugin as a
   * string.
   */
   ...
   *
   * @return the value of the "name" attribute of this TwoatonceSBasePlugin as
   * a string.
   */
  ...
  /**
   * Predicate returning @c true if this TwoatonceSBasePlugin's "id" attribute
   * is set.
   *
   * @return @c true if this TwoatonceSBasePlugin's "id" attribute has been
  ...
  /**
   * Predicate returning @c true if this TwoatonceSBasePlugin's "name"
   * attribute is set.
   *
   * @return @c true if this TwoatonceSBasePlugin's "name" attribute has been
   * set, otherwise @c false is returned.
   */
