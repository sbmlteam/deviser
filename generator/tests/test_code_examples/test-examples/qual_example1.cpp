/**
 * @file qual_example1.cpp
 * @brief Implementation of the example code for the qual package.
 * @author SBMLTeam
 *
 * <!--------------------------------------------------------------------------
...
main(int argc, char** argv)
{
  ...
  document->setPackageRequired("qual", false);
  ...
  i->setQualitativeSpecies("FIXME");

  Output* o = t->createOutput();

  o->setQualitativeSpecies("FIXME");
  o->setTransitionEffect("FIXME");

  FunctionTerm* ft = t->createFunctionTerm();

  ft->setResultLevel(FIXME);
