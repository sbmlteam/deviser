# -*- coding: utf-8 -*-
#
# Deviser documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'Deviser.tex', u'Deviser Documentation',
   u'SBML Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'deviser', u'Deviser Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Deviser', u'Deviser Documentation',
   author, 'Deviser', 'One line description of project.',
   'Miscellaneous'),
]
